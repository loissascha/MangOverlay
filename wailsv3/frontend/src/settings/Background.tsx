...
import { GetBackgroundAlpha, GetBackgroundColor, GetRoundCorners, SetBackgroundAlpha, SetBackgroundColor, SetRoundedCorners } from "../../bindings/mangoverlay/internal/services/appservice/appservice";
...
function Background() {
    ...
    useEffect(() => {
        GetBackgroundColor().then((r: any) => {
            setBackgroundColor(r)
        })
        GetBackgroundAlpha().then((r: any) => {
            if (r == "") {
                r = "0.8"
            }
