...
import { GetFontSize, SetFontSize, GetTextColor, SetTextColor, GetTextOutlineColor, SetTextOutlineColor, GetTextOutlineThickness, SetTextOutlineThickness } from "../../bindings/mangoverlay/internal/services/appservice/appservice";
...
function Text() {
    ...
    useEffect(() => {
        GetTextColor().then((r: any) => {
            setTextColor(r)
        })
        GetFontSize().then((r: any) => {
            if (r == "") {
                r = "24"
            }
            setFontSize(r)
        })
        GetTextOutlineColor().then((r: any) => {
            setTextOutlineColor(r)
        })
        GetTextOutlineThickness().then((r: any) => {
