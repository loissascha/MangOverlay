...
function Graphs() {
	...
	function updateGraphs() {
		GetGraphGpuLoad().then((r: any) => {
			setGpuLoad(r)
		})
		GetGraphCpuLoad().then((r: any) => {
			setCpuLoad(r)
		})
		GetGraphGpuCoreClock().then((r: any) => {
			setGpuCoreClock(r)
		})
		GetGraphGpuMemClock().then((r: any) => {
			setGpuMemClock(r)
		})
		GetGraphVram().then((r: any) => {
			setVram(r)
		})
		GetGraphRam().then((r: any) => {
			setRam(r)
		})
		GetGraphCpuTemp().then((r: any) => {
			setCpuTemp(r)
		})
		GetGraphGpuTemp().then((r: any) => {
			setGpuTemp(r)
		})
	}
