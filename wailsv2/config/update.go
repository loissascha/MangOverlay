...
func (c *Config) SetTextOutlineThickness(n string) {
	c.TextOutlineThickness = n
	if n == "" {
		deleteConfigLine("text_outline_thickness")
		return
	}
	updateConfigLine("text_outline_thickness", n, true)
}
