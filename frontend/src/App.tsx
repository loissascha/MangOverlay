...
function App() {
	...
	return (
		<div className={'w-full h-full text-latte-text dark:text-mocha-text grid grid-rows-[auto_1fr_auto] select-none cursor-default ' + ((showRestartModal || showHelpModal) ? ('overflow-hidden') : null)}>
			<nav className="bg-latte-surface0 dark:bg-mocha-surface0 pt-2 px-3">
				<ul className="flex gap-3 list-none">
					<li
						onClick={() => { setActiveMenuButton("general"); }}
						className={"pt-2 pb-1 px-3 cursor-pointer rounded-t-lg flex gap-2 " + (activeMenu == "general" ? "bg-latte-base dark:bg-mocha-base" : "bg-latte-surface2 dark:bg-mocha-surface1")}>
						<div>
					...
					<li
						...
						className={"pt-2 pb-1 px-3 cursor-pointer rounded-t-lg flex gap-2 " + (activeMenu == "metrics" ? "bg-latte-base dark:bg-mocha-base" : "bg-latte-surface2 dark:bg-mocha-surface1")}>
						<div>
					...
					<li
						...
						className={"pt-2 pb-1 px-3 cursor-pointer rounded-t-lg flex gap-2 " + (activeMenu == "metrics-order" ? "bg-latte-base dark:bg-mocha-base" : "bg-latte-surface2 dark:bg-mocha-surface1")}>
						<div>
					...
					<li
						...
						className={"pt-2 pb-1 px-3 cursor-pointer rounded-t-lg flex gap-2 " + (activeMenu == "manual" ? "bg-latte-base dark:bg-mocha-base" : "bg-latte-surface2 dark:bg-mocha-surface1")}>
						<div>
				...
				<div className="fixed left-0 right-0 top-0 bottom-0 bg-black bg-opacity-50 content-center">
					<div className="w-96 max-w-full bg-latte-base dark:bg-mocha-base mx-auto px-8 py-6 rounded">
						...
						<div className="text-center">
							<button className="mt-2 bg-green-300 dark:bg-green-500 hover:bg-green-400 cursor-pointer border border-green-500 px-4 py-2 rounded-md" onClick={() => {
			...
			{showHelpModal ? (
				<div className="fixed left-0 right-0 top-0 bottom-0 bg-black bg-opacity-50 content-center">
					<div className="w-96 max-w-full bg-latte-base dark:bg-mocha-base mx-auto px-8 py-6 rounded">
						...
						<div className="text-center">
							<button className="mt-2 bg-red-300 dark:bg-red-500 hover:bg-red-400 cursor-pointer border border-red-500 px-4 py-2 rounded-md" onClick={() => {
