...
function PresetButton({ children }: ButtonProps) {
  return (
    <button className="py-2 px-3 bg-latte-surface0 dark:bg-mocha-surface0 rounded border border-latte-surface2 dark:border-mocha-surface2 cursor-pointer hover:bg-latte-surface1 dark:hover:bg-mocha-surface2">
      {children}
    </button>
  );
}
