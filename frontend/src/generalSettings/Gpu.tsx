...
import { GetGpuLoadChange, SetGpuLoadColors, GetGpuLoadColor0, GetGpuLoadColor1, GetGpuLoadColor2, GetGpuText, SetGpuLoadChange, SetGpuText } from "../../wailsjs/go/main/App";
import SettingBox from "../ui/SettingBox";
import { SketchPicker } from "react-color";

function Gpu() {
    const [gpuText, setGpuText] = useState<string>("")
    const [gpuLoadChange, setGpuLoadChange] = useState<string>("")
    ...
    return (
        <SettingBox header="GPU">
            <div className="grid grid-cols-2 gap-3">
                ...
                />
                <label htmlFor="gpuloadchange" className="me-2">Load Change:</label>
                <input
                    type="text"
                    id="gpuloadchange"
                    className="w-28 bg-gray-700 p-1 border border-gray-500 rounded text-center"
