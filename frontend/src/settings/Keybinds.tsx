    ...
    return (
        <SettingBox header="Keybinds">
            <div className="grid grid-cols-2 gap-3">
                ...
                />
                <label htmlFor="togglehudposition" className="me-2">
                    Toggle Position:
                </label>
                <input
                    type="text"
                ...
                />
                <label htmlFor="togglepreset" className="me-2">
                    Toggle Preset:
                </label>
                <input
                    type="text"
                ...
                />
                <label htmlFor="togglefpslimit" className="me-2">
                    Toggle FPS Limit:
                </label>
                <input
                    type="text"
                ...
                />
                <label htmlFor="togglelogging" className="me-2">
                    Toggle Logging:
                </label>
                <input
                    type="text"
                ...
                />
                <label htmlFor="reloadcfg" className="me-2">
                    Reload Cfg:
                </label>
                <input
                    type="text"
                ...
                />
                <label htmlFor="uploadlog" className="me-2">
                    Upload Log:
                </label>
                <input
                    type="text"
